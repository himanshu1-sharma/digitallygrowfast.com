                        ...
                        <div className='row d-flex justify-content-center mt-5'>
                                ...
                                <div className={card.businessGoalsCardBg}>
                                    <div className={card.businessGoalsCard}>
                                        <div className={card.businessGoalsCardTitle}>
                                            <h4>Tour &  <br /> <span>Travel Development</span></h4>
                                        </div>
                            ...
                            <div className='col-xl-5 col-lg-5 col-sm-6 col-sm-12 col-12'>
                                <div className={card.businessGoalsCardBg}>
                                    <div className={card.businessGoalsCard}>
                                        <div className={card.businessGoalsCardTitle}>
                                            <h4>Tour & <br /> <span>Travel Designing</span></h4>
                                        </div>
                                        <p>Our team of Creative designers is expert at helping practices create and design visual pieces for all Tour & Travel marketing initiatives. Our team works with you from concept to completion to ensure brand continuity.</p>
                                        <ul>
                            ...
                            <div className='col-xl-5 col-lg-5 col-sm-6 col-sm-12 col-12'>
                                <div className={card.businessGoalsCardBg}>
                                    <div className={card.businessGoalsCard}>
                                        <div className={card.businessGoalsCardTitle}>
                                            <h4>Tour &   <br /> <span>Travel Management System</span></h4>
                                        </div>
                                        <p>Comprehensive Tour & Travel software in India is a solution with Call Management, Sales, and daily analytics all under one roof.</p>
                                        <ul>
                                            <li>For Hotel Booking</li>
                                            <li>For Cab Booking and Rental</li>
                                            <li>Flight and trip booking </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='col-xl-5 col-lg-5 col-sm-6 col-sm-12 col-12'>
                                <div className={card.businessGoalsCardBg}>
                                    <div className={card.businessGoalsCard}>
                                        <div className={card.businessGoalsCardTitle}>
                                            <h4>Tour & <br /> <span>Travel Growth Marketing</span></h4>
                                        </div>
